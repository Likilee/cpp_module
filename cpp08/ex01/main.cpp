...
int main()
{
	...
	std::cout << "======================== addNumber with iter error test end ====================" << std::endl;
	std::cout << "======================== Span bigger than int test ====================" << std::endl;

	Span int_max_test(2);
	int_max_test.addNumber(-2147483648);
	int_max_test.addNumber(2147483647);

	std::cout << int_max_test.shortestSpan() << std::endl;
	std::cout << int_max_test.longestSpan() << std::endl;
	std::cout << "======================== Span bigger than int test end ====================" << std::endl;
